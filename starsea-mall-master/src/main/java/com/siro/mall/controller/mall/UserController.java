...
public class UserController {
    ...
    @PostMapping("/personal/updateBalance")
    @ResponseBody
    public Result updateBalance(@RequestBody User mallUser, HttpSession httpSession) {
        System.out.println(mallUser);
        UserVO balance = userService.updateUserBalance(mallUser,httpSession);
        if (balance==null) {
            Result result = ResultGenerator.genFailResult("修改失败");
            return result;
        } else {
