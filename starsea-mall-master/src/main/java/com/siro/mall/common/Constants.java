...
public class Constants {
    ...
    public final static String FILE_UPLOAD_DIC = "D:\\Graduation Project\\starsea-mall-master\\src\\main\\resources\\static\\goods-img\\";//上传文件的默认url前缀，根据部署设置自行修改

    public final static int INDEX_CAROUSEL_NUMBER = 5;//首页轮播图数量(可根据自身需求修改)

    public final static int INDEX_CATEGORY_NUMBER = 8;//首页一级分类的最大数量
    ...
    public final static int INDEX_GOODS_RECOMMOND_NUMBER = 15;//首页推荐商品数量
