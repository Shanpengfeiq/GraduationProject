...
public class IndexConfigServiceImpl implements IndexConfigService {
    ...
    public List<IndexConfigGoodsVO> getConfigGoodsesForIndex(int configType, int number) {
        return ConfigGoodsesForIndex(configType,number);
    }
    @Override
    public List<IndexConfigGoodsVO> refreshConfigGoodsesForIndex(int configType, int number){
    ...
    public List<IndexConfigGoodsVO> ConfigGoodsesForIndex(int configType, int number){
